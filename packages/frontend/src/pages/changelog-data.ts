      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            ...
            'Four media seed searches added (media-flevoland, media-stikstof, media-lelystad, media-energie). MEDIA_SOURCE_ENABLED=true in dev (loopback ready). Social media / omgeving  noted in the UI as a planned second sub-source.',
