 ...
 *
 * Exported so this can be unit-tested directly against the actual `src` an
 * iframe would receive, not an intermediate variable — that gap is exactly
 * what let this bug through the first time.
 */
