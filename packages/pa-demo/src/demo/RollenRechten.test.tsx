...
describe('RollenRechten', () => {
  ...
  it('shows a pointer cursor on the switcher, unlike Dossierbeheer’s disabled role bar', () => {
    // pac-db-roleseg-btn sets cursor: default for the cockpit's (deliberately
